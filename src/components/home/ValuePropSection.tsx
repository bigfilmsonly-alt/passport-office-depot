...
function PropCard({ icon, title }: { icon: React.ReactNode; title: string }) {
  return (
    <div className="flex flex-col items-center p-3 bg-white rounded-2xl border border-line shadow-sm">
